...
class _PurchasesReportPageState extends State<PurchasesReportPage> {
  ...
  void _loadReport() {
    if (selectedLocationId != null) {
      context.read<ReportsBloc>().add(LoadPurchasesReport(
                      ...
                      children: [
                        ...
                        ...report.items.map((item) {
                          return Card(
                            ...
                            child: ListTile(
                              title: Text('Compra #${item.purchaseNumber}'),
                              subtitle: Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  Text(dateFormat.format(item.purchaseDate)),
                                  Text('Proveedor: ${item.supplierName}'),
