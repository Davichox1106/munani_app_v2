...
class EmployeesStoreFormPage extends StatefulWidget {
  final EmployeeStore? existing;
  const EmployeesStoreFormPage({super.key, this.existing});

  @override
  State<EmployeesStoreFormPage> createState() => _EmployeesStoreFormPageState();
}

class _EmployeesStoreFormPageState extends State<EmployeesStoreFormPage> {
  ...
  Future<void> _save() async {
    ...
    try {
      final repo = sl<EmployeeStoreRepository>();

      final ci = _ciController.text.trim();
      if (ci.isNotEmpty) {
        final exists = await repo.existsCi(ci, excludeId: widget.existing?.id);
        if (exists) {
          throw Exception('Ya existe un empleado de tienda con este CI');
        }
      }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: Text(isEdit ? 'Editar Empleado de Tienda' : 'Nuevo Empleado de Tienda')),
          ...
          child: Column(
            ...
            children: [
              ...
              TextFormField(
                ...
                decoration: const InputDecoration(
                  labelText: 'Cargo (Ej: Vendedor, Cajero)',
              ...
              TextFormField(
                ...
                decoration: const InputDecoration(
                  labelText: 'Departamento (Ej: Ventas, Caja)',
