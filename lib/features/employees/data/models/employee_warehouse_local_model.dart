...
part 'employee_warehouse_local_model.g.dart';

@collection
class EmployeeWarehouseLocalModel {
  ...
  factory EmployeeWarehouseLocalModel.fromEntity(EmployeeWarehouse entity) {
    return EmployeeWarehouseLocalModel()
      ..uuid = entity.id
      ..name = entity.name
